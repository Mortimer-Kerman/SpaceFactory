                           ...
                           ("OppInteractions.OnSite.3.b1",
                            lambda o:(InteractionResult.DoWithChance(o,0.3,
                                lambda o:(InteractionResult.AddResourceToInv(o, None, (10,30),"rAmount"),
                                          ...
                                          InteractionResult.OpenResultPanel(o,"OppInteractions.OnSite.3.b1.1","interactionBackgrounds/cave","rAmount")),
                                lambda o:(InteractionResult.AddResourceToInv(o, None, (10,30),"rAmount"),
                                          InteractionResult.OpenResultPanel(o,"OppInteractions.OnSite.3.b1.2","interactionBackgrounds/cave","rAmount"))),
                                      InteractionResult.ReturnToBase(o)),
                            (3,5)),
                           ("OppInteractions.OnSite.3.b2",
                            lambda o:(InteractionResult.DoWithChance(o,0.6,
                                lambda o:(InteractionResult.AddResourceToInv(o, None, (10,30),"rAmount"),
                                          InteractionResult.OpenResultPanel(o,"OppInteractions.OnSite.3.b2.1","interactionBackgrounds/walkingDesert","rAmount")),
...
interruptionInteractions=[
    ...
    OpportunityInteraction("OppInteractions.Interruption.3", "interactionBackgrounds/lyingCreature",
                           {Tags.LIVINGPLANET:True},
                           ("OppInteractions.Interruption.3.b1",
                            lambda o:(InteractionResult.OpenResultPanel(o,"OppInteractions.Interruption.3.b1.1","interactionBackgrounds/walkingJungle"),
                                      InteractionResult.ResumeTravel(o))),
                           ("OppInteractions.Interruption.3.b2",
                            lambda o:(InteractionResult.OpenResultPanel(o,"OppInteractions.Interruption.3.b2.1","interactionBackgrounds/creature"),
                                      InteractionResult.ResumeTravel(o))),
